...
#so in order to do the thresholding, I need to 
...
sdm_threshold <- function(prediction_raster, occurrence_sp, quantile = 0.05, return_binary = TRUE){
  
  predictions_at_occurrences <- extract(y = occurrence_sp,x = prediction_raster)
